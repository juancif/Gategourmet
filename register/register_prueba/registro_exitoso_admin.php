...
<head>
    ...
    <link rel="stylesheet" href="../register/style_registro_exitoso_admin.css">
</head>
<body>
<header class="header">
...
<div class="cuadro_mensaje">
    ...
    <a href="http://localhost/GateGourmet/login/login_admin.php" class="link_volver">Volver al inicio</a></button>
</div>
    <footer class="footer">
