...
$sql = "DELETE FROM usuarios WHERE nombre_usuario=:nombre_usuario"; // Aquí podrías necesitar cambiar ':nombre_usuario' a ':id' dependiendo del nombre real del parámetro en tu base de datos
