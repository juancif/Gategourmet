    ...
    if (empty($correo) || empty($nombres_apellidos) || empty($contrasena) || empty($confirmar_contrasena) || empty($area) || empty($cargo) || empty($rol)) {
        ...
        try {
            ...
            if ($query->rowCount() > 0) {
                ...
                header("Location: http://10.24.217.62/GateGourmet/Gestor_usuarios/php/user/registro_exitoso.php");
                exit();
            } else {
...
<div class="input-group tooltip">
    ...
    <span class="tooltiptext">Confirma tu contraseña.</span>
                    ...
                    <div class="buttons">
                        ...
                        <a href="http://10.24.217.62/GateGourmet/Gestor_usuarios/php/user/index_gestor.php" class="regresar">Regresar</a>
                    </div>
                </form>
            </div>
        </div>
