...
$query = $dbConn->query("
    SELECT correo, nombres_apellidos, nombre_usuario, area, cargo, rol FROM inactivos WHERE estado = 'inactivo'
");
...
header('Content-Disposition: attachment;filename="usuarios_y_administradores_inactivos.xlsx"');
