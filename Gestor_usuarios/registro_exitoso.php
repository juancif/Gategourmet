...
<head>
    ...
    <link rel="stylesheet" href="../register/style_registro_exitoso.css">
</head>
<body>
<header class="header">
...
<div class="cuadro_mensaje">
    ...
    <a href="http://localhost/GateGourmet/Gestor_usuarios/index_gestor.php" class="link_volver">Volver al inicio</a></button>
</div>
    <footer class="footer">
