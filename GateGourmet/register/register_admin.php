...
$sql = "INSERT INTO administradores (nombre_usuario, contrasena, correo, nombres, apellidos, tipo_documento, documento, area, tipo_usuario) 
...
<body>
    <header class="header">
        <img src="../register/Logo_oficial_B-N.png" alt="Gate Gourmet Logo" class="logo">
    </header>
                ...
                <form method="post" action="http://localhost/Pagina_Prueba/index/Prueba_index/login_register/register/register_admin.php">
                    ...
                    <div class="input-group">
                        ...
                        <select id="tipo_usuario" name="tipo_usuario" required>
                            ...
                            <option value="jefe_de_nombres">Jefe de Area</option>
                        </select>
                    </div>
                    <div class="buttons">
                    <input type="Submit" name="Submit" value="Registrarse" class="Registrarse"></input>
                        <a href="http://localhost/Pagina_Prueba/index/Prueba_index/login_register/login/login_admin.php" class="button">Regresar</a>
                    </div>
                </form>
            </div>
        </div>
