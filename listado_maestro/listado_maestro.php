...
// Ordenar por área para agrupar los documentos
$sql .= " ORDER BY areas ASC, fecha_aprobacion DESC";
    ...
    <?php if (isset($result) && $result->num_rows > 0): ?>
        <div class="table-wrapper">
            <table>
                ...
                <tbody>
                    <?php 
                    $currentArea = ''; // Variable para rastrear el área actual
                    while($row = $result->fetch_assoc()): 
                        ...
                        // Si el área cambia, mostrar el nombre del área en la tabla
                        if ($currentArea !== $row['areas']) {
                            $currentArea = $row['areas'];
                            echo "<tr class='area-row'><td colspan='100%'>Área: " . htmlspecialchars($currentArea) . "</td></tr>";
                        }
                    ?>
